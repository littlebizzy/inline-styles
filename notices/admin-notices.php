...
namespace LittleBizzy\InlineStyles\Notices;

// Aliased namespaces
use LittleBizzy\InlineStyles as Plugin;
...
final class Admin_Notices {
	...
	private $rate_us_url = 'https://wordpress.org/support/plugin/inline-styles-littlebizzy/reviews/?rate=5#new-post';
